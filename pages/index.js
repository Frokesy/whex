        ...
        <div className="flex items-center justify-center space-x-10">
          <div className="flex flex-row justify-center">
            <a href="https://twitter.com/whaleexploder" target="_blank" rel="noreferrer">
              <img src="/twitter.svg" alt="twitter" data-aos="fade-up-right" data-aos-duration="2000" className="w-[2rem] h-[2rem] my-4 mx-3" />
            </a>
            <a href="https://t.me/WHEXcosystem" target="_blank" rel="noreferrer">
              <img src="/telegram.svg" alt="telegram" data-aos="fade-up" data-aos-duration="2000" className="w-[2rem] h-[2rem] my-4 mx-3" />
            </a>
            <a href="https://www.mintme.com/token/Whale-Exploder-Ecosystem-Daov2/MINTME/trade" target="_blank" rel="noreferrer">
                <img src="/mintme.png" alt="mintme" data-aos="fade-up-right" data-aos-duration="2000" className="w-[2rem] h-[2rem] my-4 mx-3" />
              </a>
            <a href="https://www.reddit.com/r/WHEX/" target="_blank" rel="noreferrer">
              <img src="/reddit.svg" alt="reddit" data-aos="fade-down" data-aos-duration="2000" className="w-[2rem] h-[2rem] my-4 mx-3" />
            </a>
            ...
            <a href="https://pancakeswap.finance/swap?outputCurrency=0x31e79A378fb85D8c4d51489E5c90ecAF9c17935A" target="_blank" rel="noreferrer">
              <img src="/pcs.png" alt="pcs" data-aos="fade-left" data-aos-duration="2000" className="w-[2rem] h-[2rem] my-4 mx-3" />
            </a>
            <a href="https://coinmarketcap.com/currencies/whale-exploder/" target="_blank" rel="noreferrer">
              <img src="/cmc.svg" alt="cmc" data-aos="fade-up-right" data-aos-duration="2000" className="w-[4rem] h-[2rem] my-4 mr-3" />
            </a>
        </div>
          </div>
        </div>
