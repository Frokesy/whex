      ...
      <div className="grid lg:grid-cols-3 grid-cols-1 mt-10 gap-6">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <span className="text-[14px] text-neutral-400 font-semibold  ">
            {">>"} 2% sent to the treasury wallet (formerly charity/burn
            wallet). Then when it reaches 10 quintillion WHEX:
          </span>
          <span className="text-[14px] text-neutral-400 font-semibold  ">
            {">>"} 25% is burned
          </span>
        ...
        >
          <h2 className="flex text-gray-100 text-[18px] font-mono font-bold">
            Locked Liquidity
          </h2>
          ...
          <span className="text-[14px] font-semibold text-neutral-400">
            ...
            2021 for 5 years. This was done on dxsale.app, These can be seen on
            BSC Scan here: 0xeb3a9c56d963b971d320f889be2fb8b59853e449
          </span>
          <span className="text-[14px] font-semibold text-neutral-400">
            {">>"} Automatic LP (13% of each transaction):
            0x07d80ae6f36a5e08dca74ce884a24d39db9934ed.LP from IDO will be
            locked in dxsale.app for 5 years. Additional LP has been sent to
            this initial contract since the first 1 BNB and is locked.
          </span>
        </div>
      </div>
