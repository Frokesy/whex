  ...
  return (
    <div>
       <div className="pt-[10vh] lg:w-[85vw] w-[90vw]">
            <h2 className="text-white lg:text-[30px] text-[22px] font-bold">NFTs/Cryptocurrencies</h2>
            <div className="grid lg:grid-cols-3 grid-cols-1 lg:gap-10 gap-y-10 pt-6 lg:w-[85vw] w-[90vw] mx-auto">
