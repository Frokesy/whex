        ...
        >
            ...
            <div className="flex flex-col mx-4 space-y-3 mt-4 text-neutral-400">
                        ...
                        <span className="text-[14px] font-mono font-semibold">
                            ...
                            target="_blank" rel="noreferrer" className="text-teal-600 font-light">
                     ...
                     <span className="text-[14px] font-mono font-semibold  ">
                        ...
                        <div className="flex flex-col py-2 text-[12px] font-mono font-normal  ">
                            <span>
                              {">>"} 1916-2099: 0.275 ETH 
                            </span>
                            <span>
                        ...
                        >
                            {isWhexyVisible ? (
                              <button className="bg-sky-900 mt-8 font-light text-white rounded-lg font-mono text-[11px] px-6 py-4">Click to hide</button>
                            ) : (
                                <button className="bg-sky-900 mt-8 font-light text-white rounded-lg font-mono text-[11px] px-6 py-4">Click to expand</button>
                            )}
                        </div>
                    </div>
        </motion.div>
