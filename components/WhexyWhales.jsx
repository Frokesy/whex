    ...
    <div className="pt-[10vh] overflow-x-hidden" id="whexy">
      ...
      >
        <img
          src="/whexy.png"
          alt="whexy-logo"
          className="rounded-full lg:w-[6rem] md:w-[4rem] w-[4rem]"
        />
        <div>
          <span className="lg:text-[32px] text-[20px] font-extrabold text-white">
            WHEXy whales (NFT)
          </span>
          <span className="flex justify-start lg:text-center text-neutral-400 lg:text-[13px] text-[12px] font-normal">
